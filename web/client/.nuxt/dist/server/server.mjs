import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, defineComponent, computed, unref, provide, ref, watch, h, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, createElementBlock, cloneVNode, toValue, onServerPrefetch, nextTick, Suspense, Fragment, withAsyncContext, useSSRContext, defineAsyncComponent, mergeProps, onErrorCaptured, createVNode, resolveDynamicComponent, createApp } from "vue";
import { $fetch } from "E:/Cpenx/bbs/web/client/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "E:/Cpenx/bbs/web/client/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "E:/Cpenx/bbs/web/client/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, getRequestHeaders, getRequestHeader, setCookie, getCookie, deleteCookie } from "E:/Cpenx/bbs/web/client/node_modules/h3/dist/index.mjs";
import { shouldHydrate, setActivePinia, createPinia, defineStore } from "pinia";
import { defu } from "E:/Cpenx/bbs/web/client/node_modules/defu/dist/defu.mjs";
import { toRouteMatcher, createRouter as createRouter$1 } from "E:/Cpenx/bbs/web/client/node_modules/radix3/dist/index.mjs";
import { hasProtocol, isScriptProtocol, joinURL, withQuery } from "E:/Cpenx/bbs/web/client/node_modules/ufo/dist/index.mjs";
import { klona } from "E:/Cpenx/bbs/web/client/node_modules/klona/dist/index.mjs";
...
import { parse } from "E:/Cpenx/bbs/web/client/node_modules/cookie-es/dist/index.mjs";
import destr from "E:/Cpenx/bbs/web/client/node_modules/destr/dist/index.mjs";
import { isEqual } from "E:/Cpenx/bbs/web/client/node_modules/ohash/dist/index.mjs";
import { debounce } from "E:/Cpenx/bbs/web/client/node_modules/perfect-debounce/dist/index.mjs";
if (!globalThis.$fetch) {
...
const _routes = [
  {
    name: "error",
    path: "/error",
    component: () => import("./_nuxt/error-CRg_vi3A.js")
  },
  {
    name: __nuxt_page_meta?.name,
    path: "/",
    component: () => import("./_nuxt/index-DrgsVNit.js"),
    children: [
      {
        name: __nuxt_page_meta$1?.name,
        path: "",
        component: () => import("./_nuxt/index-CrRxqD7m.js"),
        children: [
          {
            name: "index-index-add",
            path: "add",
            component: () => import("./_nuxt/add-Bu03XIQQ.js")
          },
          {
            name: "index-index-class",
            path: "class",
            component: () => import("./_nuxt/class-CY1EsWqD.js")
          },
          {
            name: "index-index",
            path: "",
            component: () => import("./_nuxt/index-B0sJqS7y.js")
          },
          {
            name: "index-index-follow",
            path: "follow",
            component: () => import("./_nuxt/follow-BM5S6yr6.js")
          },
          {
            name: "index-index-images",
            path: "images",
            component: () => import("./_nuxt/images-DsAjYXWZ.js")
          },
          {
            name: "index-index-uplist",
            path: "uplist",
            component: () => import("./_nuxt/uplist-D2NMQRaV.js")
          },
          {
            name: "index-index-plate-id",
            path: "plate/:id()",
            component: () => import("./_nuxt/_id_-CbWtxJ4I.js")
          },
          {
            name: "index-index-topic-id",
            path: "topic/:id()",
            component: () => import("./_nuxt/_id_-BQi9rAX6.js")
          },
          {
            name: "index-index-threads-404",
            path: "threads/404",
            component: () => import("./_nuxt/404-2aFnDzHo.js")
          },
          {
            name: "index-index-upinfo-id",
            path: "upinfo/:id()",
            component: () => import("./_nuxt/_id_-DKZQsXYX.js")
          },
          {
            name: "index-index-threads-id",
            path: "threads/:id()",
            component: () => import("./_nuxt/_id_-C8FXVHvJ.js")
          },
          {
            name: "index-index-threadInfo-id",
            path: "threadInfo/:id()",
            component: () => import("./_nuxt/_id_-CXnviqWv.js")
          }
        ]
      },
      {
        name: "index-notic-id",
        path: "notic/:id()",
        component: () => import("./_nuxt/_id_-Cp7UvmNs.js")
      },
      {
        name: "index-user",
        path: "user",
        component: () => import("./_nuxt/index-CvKbH_3U.js"),
        children: [
          {
            name: "index-user-index-vip",
            path: "vip",
            component: () => import("./_nuxt/vip-BgIsRm_W.js")
          },
          {
            name: "index-user-index-bill",
            path: "bill",
            component: () => import("./_nuxt/bill-DmQNMt88.js")
          },
          {
            name: "index-user-index-home",
            path: "home",
            component: () => import("./_nuxt/home-DRQ12nYo.js")
          },
          {
            name: "index-user-index-keys",
            path: "keys",
            component: () => import("./_nuxt/keys-BAVhW6nt.js")
          },
          {
            name: "index-user-index-topup",
            path: "topup",
            component: () => import("./_nuxt/topup-DE5isGXG.js")
          },
          {
            name: "index-user-index-editInfo",
            path: "editInfo",
            component: () => import("./_nuxt/editInfo-sPD3FSUb.js")
          },
          {
            name: "index-user-index-withdraw",
            path: "withdraw",
            component: () => import("./_nuxt/withdraw-DBn1w_OB.js")
          },
          {
            name: "index-user-index-order-id",
            path: "order/:id()",
            component: () => import("./_nuxt/_id_-CinBDwsG.js")
          },
          {
            name: "index-user-index-activity-sign",
            path: "activity/sign",
            component: () => import("./_nuxt/sign-Dj0FQ60N.js")
          }
        ]
      }
    ]
  },
  {
    name: "login",
    path: "/login",
    component: () => import("./_nuxt/login-DGljfWRg.js")
  },
  {
    name: "index copy",
    path: "/index%20copy",
    component: () => import("./_nuxt/index copy-CyzeT1Rs.js")
  }
];
...
const namedMiddleware = {
  "redirect-device": () => import("./_nuxt/redirectDevice-VYplkK80.js")
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-BPOdM3sf.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-DnRADCQL.js"));
