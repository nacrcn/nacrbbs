                ...
                <div class="Items">
                    ...
                    <a-form :model="form" :layout="'vertical'">
                        ...
                        <a-form-item field="post" label="权限">
                           ...
                           <a-form-item field="name" label="点赞量">
                            <a-input class="road" v-model="form.n_starts" placeholder="请输入标题" />
                        </a-form-item>
                        <a-form-item field="name" label="阅读量">
                            <a-input class="road" v-model="form.n_read" placeholder="请输入标题" />
                        </a-form-item>
...
const SubmitForm = async () => {
    ...
    try {
        ...
        if(id == 'add') {
            ...
            res = await useApiFetch().post('/api/EditThreadsAdmin', subFrom)
        }
        if (res.code == 200) {
